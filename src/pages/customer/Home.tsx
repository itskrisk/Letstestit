...
export default function Home() {
    return (
        <main>
            ...
            {/* Quiet Luxury Partner/Rider Section - GREEN (ZONE 3) UNBOXED */}
            <section className="relative py-0 bg-[#00A082] text-white">
                ...
                <div className="flex flex-col lg:flex-row border-y border-white/20">

                    {/* Merchant Canvas */}
                    <div className="flex-1 py-20 px-8 lg:px-20 border-b lg:border-b-0 lg:border-r border-white/20 group relative overflow-hidden">
                        <div className="relative z-10 transition-transform duration-700 group-hover:-translate-y-1">
                            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#D4AF37] mb-8 block">The Collective</span>
                            <h2 className="text-5xl font-heading font-light text-white mb-8 leading-[1.1] tracking-tight">
                                Build Your <br />
                                Legacy.
                            </h2>
                            <p className="text-lg text-white/90 font-light max-w-sm mb-12 leading-relaxed">
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <Link to="/partner/login" className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/60 hover:text-white transition-colors">
                                    Login
                                </Link>
                            </div>
                        </div>
                        <div className="absolute inset-0 opacity-[0.03] grayscale pointer-events-none group-hover:opacity-[0.08] transition-opacity duration-1000">
                            <img src="https://images.unsplash.com/photo-1555396273-367ea4eb4db5?q=80&w=1000" alt="" className="w-full h-full object-cover" />
                        </div>
                    </div>

                    {/* Rider Canvas */}
                    <div className="flex-1 py-20 px-8 lg:px-20 group relative overflow-hidden">
                        <div className="relative z-10 transition-transform duration-700 group-hover:-translate-y-1">
                            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#D4AF37] mb-8 block">The Movement</span>
                            <h2 className="text-5xl font-heading font-light text-white mb-8 leading-[1.1] tracking-tight">
                                Own the <br />
                                Streets.
                            </h2>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <Link to="/courier/login" className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/60 hover:text-white transition-colors">
                                    Login
                                </Link>
                            </div>
                        </div>
                        <div className="absolute inset-0 opacity-[0.03] grayscale pointer-events-none group-hover:opacity-[0.08] transition-opacity duration-1000">
                            <img src="https://images.unsplash.com/photo-1558618666-fcd25c85f82e?q=80&w=1000" alt="" className="w-full h-full object-cover" />
                        </div>
                    </div>
