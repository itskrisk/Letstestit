                                ...
                                <div className="mt-auto pt-8 border-t border-black/5">
                                    <div className="flex items-center gap-4 mb-4 px-4">
                                        <div
                                            ...
                                            style={{
                                                backgroundColor: `${merchant.branding?.primaryColor || '#00A082'}1A`,
                                                borderColor: `${merchant.branding?.primaryColor || '#00A082'}33`
                                            }}
                                        >
                                            {profile?.full_name ? (
                                                <span className="text-xs font-black" style={{ color: merchant.branding?.primaryColor || '#00A082' }}>{profile.full_name.charAt(0).toUpperCase()}</span>
                                            ) : (
                                                <User size={18} style={{ color: merchant.branding?.primaryColor || '#00A082' }} />
                                            )}
                                        </div>
                                        <div>
                                            ...
                                            <div className="text-[9px] font-bold uppercase tracking-widest" style={{ color: merchant.branding?.primaryColor || '#00A082' }}>
