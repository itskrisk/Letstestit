        ...
        <div className="min-h-screen bg-white flex overflow-hidden">
            ...
            <div className="hidden lg:block lg:w-1/2 relative">
                ...
                <div className="absolute bottom-16 left-16 z-10 max-w-sm">
                    <span className="text-[9px] font-bold uppercase tracking-[0.5em] text-white/50 mb-5 block">Fleet Network</span>
                    <h2 className="text-5xl font-heading font-light text-white leading-[1.1] tracking-tight mb-6">
                        Deliver<br />
                        <span className="italic opacity-40">Freedom</span>.
                    </h2>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-14 lg:px-20 py-14 overflow-y-auto">
                ...
                <div className="mb-10 border-b border-black/10 pb-8">
                    <h1 className="text-3xl font-heading font-light text-black tracking-tight mb-2">Join the fleet.</h1>
                    <p className="text-sm text-black/40">
                        Already a courier?{' '}
                        <Link to="/courier/login" className="text-black font-medium underline underline-offset-2 hover:text-black/60 transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
                ...
                >
                    ...
                    <form onSubmit={handleSignup} className="space-y-6">
                        ...
                        <p className="text-[10px] text-black/30 leading-relaxed pt-1">
                            By signing up, you agree to the Muncheez Fleet Terms & Courier Operational Policy.
                        </p>

                        <div className="pt-1">
                            <button
                                id="courier-signup-btn"
                                type="submit"
                                disabled={loading}
                            ...
                            >
                                <span>{loading ? 'Registering...' : 'Join Courier Fleet'}</span>
                                {loading
                    ...
                    <div className="mt-10 pt-6 border-t border-black/8 flex items-center justify-between">
                        ...
                        <a href="mailto:couriers@muncheez.co.ke" className="text-[10px] font-bold text-black underline underline-offset-2 hover:text-black/50 transition-colors">
                            Fleet Support
                        </a>
                    </div>
                </motion.div>
