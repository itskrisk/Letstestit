...
const ProfileModal: React.FC<ProfileModalProps> = ({ isOpen, onClose }) => {
    ...
    const [view, setView] = React.useState<'profile' | 'orders'>('profile');

    // Filter orders for this user (using phone as ID for mock)
            ...
            {isOpen && (
                <div className="fixed inset-0 z-[60] flex items-center justify-center px-6 text-black">
                    ...
                    >
                        ...
                        <div className="p-6 flex flex-col items-center pt-8 h-[500px] overflow-hidden">
